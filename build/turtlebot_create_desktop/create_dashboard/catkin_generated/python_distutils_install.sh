...
cd "/home/sl-zhang/turtlebot/src/turtlebot_create_desktop/create_dashboard"
...
/usr/bin/env \
    ...
    build --build-base "/home/sl-zhang/turtlebot/build/turtlebot_create_desktop/create_dashboard" \
    install \
    $DESTDIR_ARG \
