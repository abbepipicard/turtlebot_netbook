...
cd "/home/sl-zhang/turtlebot/src/turtlebot_apps/software/pano/pano_ros"
...
/usr/bin/env \
    ...
    build --build-base "/home/sl-zhang/turtlebot/build/turtlebot_apps/software/pano/pano_ros" \
    install \
    $DESTDIR_ARG \
