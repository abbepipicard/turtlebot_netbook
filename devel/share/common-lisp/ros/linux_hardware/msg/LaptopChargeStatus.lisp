...
(cl:in-package linux_hardware-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <LaptopChargeStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaptopChargeStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name linux_hardware-msg:<LaptopChargeStatus> is deprecated: use linux_hardware-msg:LaptopChargeStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:header-val is deprecated.  Use linux_hardware-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:voltage-val is deprecated.  Use linux_hardware-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'rate-val :lambda-list '(m))
(cl:defmethod rate-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:rate-val is deprecated.  Use linux_hardware-msg:rate instead.")
  (rate m))

(cl:ensure-generic-function 'charge-val :lambda-list '(m))
(cl:defmethod charge-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:charge-val is deprecated.  Use linux_hardware-msg:charge instead.")
  (charge m))

(cl:ensure-generic-function 'capacity-val :lambda-list '(m))
(cl:defmethod capacity-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:capacity-val is deprecated.  Use linux_hardware-msg:capacity instead.")
  (capacity m))

(cl:ensure-generic-function 'design_capacity-val :lambda-list '(m))
(cl:defmethod design_capacity-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:design_capacity-val is deprecated.  Use linux_hardware-msg:design_capacity instead.")
  (design_capacity m))

(cl:ensure-generic-function 'percentage-val :lambda-list '(m))
(cl:defmethod percentage-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:percentage-val is deprecated.  Use linux_hardware-msg:percentage instead.")
  (percentage m))

(cl:ensure-generic-function 'charge_state-val :lambda-list '(m))
(cl:defmethod charge_state-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:charge_state-val is deprecated.  Use linux_hardware-msg:charge_state instead.")
  (charge_state m))

(cl:ensure-generic-function 'present-val :lambda-list '(m))
(cl:defmethod present-val ((m <LaptopChargeStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader linux_hardware-msg:present-val is deprecated.  Use linux_hardware-msg:present instead.")
  (present m))
