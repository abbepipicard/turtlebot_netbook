...
if("TRUE" STREQUAL "TRUE")
  set(yocs_virtual_sensor_SOURCE_PREFIX /home/sl-zhang/turtlebot/src/yujin_ocs/yocs_virtual_sensor)
  set(yocs_virtual_sensor_DEVEL_PREFIX /home/sl-zhang/turtlebot/devel)
  ...
  set(yocs_virtual_sensor_INSTALL_PREFIX /home/sl-zhang/turtlebot/install)
...
if(NOT "/home/sl-zhang/turtlebot/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include" STREQUAL "")
  set(yocs_virtual_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/sl-zhang/turtlebot/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'yocs_virtual_sensor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jorge Santos <jorge@yujinrobot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'yocs_virtual_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sl-zhang/turtlebot/src/yujin_ocs/yocs_virtual_sensor/${idir}'.  Ask the maintainer 'Jorge Santos <jorge@yujinrobot.com>' to fix it.")
    endif()
